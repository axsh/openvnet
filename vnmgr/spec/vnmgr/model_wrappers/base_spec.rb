...
describe Vnmgr::ModelWrappers::Base do
  ...
  describe "class method" do
    describe "single execution" do
      ...
      before(:each) do
        Vnmgr::ModelWrappers::Parent.stub(:_proxy).and_return(proxy)
      end

      subject do
        Vnmgr::ModelWrappers::Parent.all
      end

      it { expect(subject).to be_a Array }
      it { expect(subject.size).to eq 1 }
      it { expect(subject.first).to be_a Vnmgr::ModelWrappers::Parent }
    ...
    describe "batch" do
      ...
      subject do
        Vnmgr::ModelWrappers::Parent.batch["p-xxx"].children.first.commit
      end

      it { expect(subject).to be_a Vnmgr::ModelWrappers::Child }
    ...
    describe "commit" do
      ...
      subject do
        Vnmgr::ModelWrappers::Parent.batch["p-xxx"].children.first.commit(:fill => [:friends, {:children => :friends}])
      end

      it { expect(subject).to be_a Vnmgr::ModelWrappers::Child }
      it { expect(subject.friends).to be_a Array }
      it { expect(subject.friends.size).to eq 1 }
      it { expect(subject.friends.first).to be_a Vnmgr::ModelWrappers::ChildFriend }
      ...
      it { expect(subject.children.first).to be_a Vnmgr::ModelWrappers::GrandChild }
      ...
      it { expect(subject.children.first.friends.first).to be_a Vnmgr::ModelWrappers::GrandChildFriend }
  ...
  describe "instance method" do
    describe "batch" do
      ...
      it "execute batch" do
        parent = Vnmgr::ModelWrappers::Parent["p-xxx"]
        parent = parent.batch.update(:name => "parent").commit
        expect(parent).to be_a Vnmgr::ModelWrappers::Parent
