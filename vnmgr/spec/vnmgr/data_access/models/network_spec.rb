...
describe Vnmgr::DataAccess::Models::Network do
  ...
  describe "[]" do
    it "not found" do
      expect(Vnmgr::DataAccess::Models::Network.new["nw-test"]).to be_nil
    end

    it "successfully" do
      network = Fabricate(:network)
      ret = Vnmgr::DataAccess::Models::Network.new[network.canonical_uuid]
  ...
  describe "update" do
    it "raise execption" do
      expect{ Vnmgr::DataAccess::Models::Network.new.update("nw-test") }.to raise_error
    end
