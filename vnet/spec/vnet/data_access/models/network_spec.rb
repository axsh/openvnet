...
describe Vnet::DataAccess::Models::Network do
  describe "all" do
    it "return empty array" do
      ret = Vnet::DataAccess::Models::Network.new.all
  ...
  describe "[]" do
    it "not found" do
      expect(Vnet::DataAccess::Models::Network.new["nw-test"]).to be_nil
    end

    it "successfully" do
      network = Fabricate(:network)
      ret = Vnet::DataAccess::Models::Network.new[network.canonical_uuid]
  ...
  describe "update" do
    it "raise execption" do
      expect{ Vnet::DataAccess::Models::Network.new.update("nw-test") }.to raise_error
    end

    it "successfully" do
      network = Fabricate(:network)
      ret = Vnet::DataAccess::Models::Network.new.execute_batch(
