...
describe Vnet::Openflow::CookieCategory do

  describe "initial state" do
    subject do
      Vnet::Openflow::CookieCategory.new(0x1001, 5)
    end
  ...
  describe "first cookie (state)" do
    subject do
      category = Vnet::Openflow::CookieCategory.new(0x1001, 5)
...
describe Vnet::Openflow::CookieManager do

  describe "initial state" do
    subject do
      Vnet::Openflow::CookieManager.new
    end
  ...
  describe "one category (initial state)" do
    subject do
      cm = Vnet::Openflow::CookieManager.new
