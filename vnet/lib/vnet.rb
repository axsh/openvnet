...
module Vnet
  ...
  module ModelWrappers
    ...
    autoload :Topology, 'vnet/model_wrappers/wrappers'
    autoload :TopologyDatapath, 'vnet/model_wrappers/wrappers'
    autoload :TopologyNetwork, 'vnet/model_wrappers/wrappers'
