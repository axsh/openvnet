...
module Vnet::Core
  ...
  class SegmentManager < Vnet::Core::Manager
    ...
    def set_interface_port(interface_id, port)
      debug log_format_h("set_interface_port", interface_id: interface_id, port: port)
    ...
    def insert_interface_segment(interface_id, segment_id)
      debug log_format_h("insert_interface_segment", interface_id: interface_id, segment_id: segment_id)
