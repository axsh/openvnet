...
module Vnet
  module Constants
    module OpenflowFlows
      ...
      ROUTING_TABLE_INDEX = 30
      ROUTING_TABLE_SIZE  = 10
      ROUTING_TABLE_MAX_N = 3

      TABLE_ROUTE_INGRESS_INTERFACE    = 0
      TABLE_ROUTE_INGRESS_TRANSLATION  = 1
      TABLE_ROUTER_INGRESS_LOOKUP      = 2
      TABLE_ROUTER_CLASSIFIER          = 3
      TABLE_ROUTER_EGRESS_LOOKUP       = 4
      TABLE_ROUTE_EGRESS_LOOKUP        = 5
      TABLE_ROUTE_EGRESS_TRANSLATION   = 6
      TABLE_ROUTE_EGRESS_INTERFACE     = 7
      TABLE_ROUTE_NETWORK_HOP          = 8

      # For vnflows, do not use in code:

      TABLE_ROUTE_INGRESS_INTERFACE_0   = 30
      TABLE_ROUTE_INGRESS_TRANSLATION_0 = 31
      TABLE_ROUTER_INGRESS_LOOKUP_0     = 32
      TABLE_ROUTER_CLASSIFIER_0         = 33
      TABLE_ROUTER_EGRESS_LOOKUP_0      = 34
      TABLE_ROUTE_EGRESS_LOOKUP_0       = 35
      TABLE_ROUTE_EGRESS_TRANSLATION_0  = 36
      TABLE_ROUTE_EGRESS_INTERFACE_0    = 37
      TABLE_ROUTE_NETWORK_HOP_0         = 38

      TABLE_ROUTE_INGRESS_INTERFACE_1   = 40
      TABLE_ROUTE_INGRESS_TRANSLATION_1 = 41
      TABLE_ROUTER_INGRESS_LOOKUP_1     = 42
      TABLE_ROUTER_CLASSIFIER_1         = 43
      TABLE_ROUTER_EGRESS_LOOKUP_1      = 44
      TABLE_ROUTE_EGRESS_LOOKUP_1       = 45
      TABLE_ROUTE_EGRESS_TRANSLATION_1  = 46
      TABLE_ROUTE_EGRESS_INTERFACE_1    = 47
      TABLE_ROUTE_NETWORK_HOP_1         = 48

      TABLE_ROUTE_INGRESS_INTERFACE_2   = 50
      TABLE_ROUTE_INGRESS_TRANSLATION_2 = 51
      TABLE_ROUTER_INGRESS_LOOKUP_2     = 52
      TABLE_ROUTER_CLASSIFIER_2         = 53
      TABLE_ROUTER_EGRESS_LOOKUP_2      = 54
      TABLE_ROUTE_EGRESS_LOOKUP_2       = 55
      TABLE_ROUTE_EGRESS_TRANSLATION_2  = 56
      TABLE_ROUTE_EGRESS_INTERFACE_2    = 57
      TABLE_ROUTE_NETWORK_HOP_2         = 58

      #
      # Post-routing tables:
      #

      POST_ROUTING_TABLE_INDEX = 100

      TABLE_ARP_TABLE                        = POST_ROUTING_TABLE_INDEX + 0
      TABLE_ARP_LOOKUP                       = POST_ROUTING_TABLE_INDEX + 1

      TABLE_NETWORK_DST_CLASSIFIER           = POST_ROUTING_TABLE_INDEX + 2
      TABLE_NETWORK_DST_MAC_LOOKUP           = POST_ROUTING_TABLE_INDEX + 3

      TABLE_INTERFACE_INGRESS_FILTER         = POST_ROUTING_TABLE_INDEX + 5
      TABLE_INTERFACE_INGRESS_FILTER_LOOKUP  = POST_ROUTING_TABLE_INDEX + 6

      TABLE_FLOOD_SIMULATED                  = POST_ROUTING_TABLE_INDEX + 10
      TABLE_FLOOD_LOCAL                      = POST_ROUTING_TABLE_INDEX + 11
      TABLE_FLOOD_TUNNELS                    = POST_ROUTING_TABLE_INDEX + 12
      TABLE_FLOOD_SEGMENT                    = POST_ROUTING_TABLE_INDEX + 13

      TABLE_LOOKUP_IF_NW_TO_DP_NW            = POST_ROUTING_TABLE_INDEX + 20
      TABLE_LOOKUP_IF_RL_TO_DP_RL            = POST_ROUTING_TABLE_INDEX + 21
      TABLE_LOOKUP_DP_NW_TO_DP_NETWORK       = POST_ROUTING_TABLE_INDEX + 22
      TABLE_LOOKUP_DP_RL_TO_DP_ROUTE_LINK    = POST_ROUTING_TABLE_INDEX + 23
      TABLE_LOOKUP_NETWORK_TO_HOST_IF_EGRESS = POST_ROUTING_TABLE_INDEX + 24
      ...
      TABLE_OUTPUT_DP_NETWORK_DST_IF    = POST_ROUTING_TABLE_INDEX + 30
      TABLE_OUTPUT_DP_NETWORK_SRC_IF    = POST_ROUTING_TABLE_INDEX + 31

      TABLE_OUTPUT_DP_ROUTE_LINK_DST_IF = POST_ROUTING_TABLE_INDEX + 32
      TABLE_OUTPUT_DP_ROUTE_LINK_SRC_IF = POST_ROUTING_TABLE_INDEX + 34

      TABLE_OUTPUT_DP_OVER_MAC2MAC      = POST_ROUTING_TABLE_INDEX + 35 # Match src/dst if id, output if present.
      TABLE_OUTPUT_DP_OVER_TUNNEL       = POST_ROUTING_TABLE_INDEX + 36 # Use tun_id to determine type for goto_table.
      ...
      # tables.
      TABLE_OUT_PORT_INTERFACE_INGRESS  = POST_ROUTING_TABLE_INDEX + 40
      TABLE_OUT_PORT_INTERFACE_EGRESS   = POST_ROUTING_TABLE_INDEX + 41
      TABLE_OUT_PORT_TUNNEL             = POST_ROUTING_TABLE_INDEX + 42
