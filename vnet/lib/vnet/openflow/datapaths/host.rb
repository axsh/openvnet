...
module Vnet::Openflow::Datapaths
  ...
  class Host < Base
    ...
    def activate_route_link_id(route_link_id)
      ...
      @dp_info.tunnel_manager.update(event: :added_host_datapath_route_link, dprl: route_link)
    end
    ...
    def deactivate_route_link_id(route_link_id)
      ...
      @dp_info.tunnel_manager.update(event: :removed_host_datapath_route_link, dprl: route_link)
    end
