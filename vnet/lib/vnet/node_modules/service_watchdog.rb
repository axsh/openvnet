  ...
  module NodeModules
    class ServiceWatchdog
      ...
      def handle_timer
        ...
        debug log_format_h('completed watchdog timer', polling: @polling.size, completed: completed.size, unresponsive: unresponsive.size)

        @timer = after(@interval) { handle_timer }
      end

      def handle_completed(id, entry, value)
        debug log_format_h('handling completed check', value)
