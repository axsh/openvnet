  ...
  class DatabaseMediator
    ...
    def create_entry(vdc_model_class, vdc_params)
      if vnet_model_classes = table[vdc_model_class]
        ...
        error "corresponded model class has not been found to create an entry for #{vdc_model_class}"
      end
    end
    ...
    def destroy_entry(vdc_model_class, uuid)
      if vnet_model_classes = table[vdc_model_class]
        ...
        error "corresponded model class has not been found to delete an entry for #{vdc_model_class}"
      end
    end
