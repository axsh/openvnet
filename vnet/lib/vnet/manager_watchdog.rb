  ...
  class Manager
    module Watchdog
      ...
      def watchdog_register
        ...
        watchdog.register_actor(@watchdog_id, Celluloid::CellProxy.new(a.proxy, a.mailbox, @watchdog_id))
      ...
      def watchdog_unregister
        ...
        # watchdog.unregister_actor(@watchdog_id, Thread.current[:celluloid_actor].future)
      end
